...
![MIDI Time Machine screenshot](screenshot.png)
...
- Automatically captures MIDI input and saves each session to a separate file.
- One-button playback of your last recorded session.
...
Insert the plugin into your FX chain, before your virtual instruments. It will silently capture all MIDI passing through it and save each session automatically.
